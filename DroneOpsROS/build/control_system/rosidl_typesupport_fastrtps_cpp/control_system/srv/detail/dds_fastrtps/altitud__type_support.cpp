...
#include "control_system/srv/detail/altitud__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_system::srv::Altitud_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_system::srv::Altitud_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<control_system::srv::Altitud_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_control_system
const rosidl_message_type_support_t *
get_message_type_support_handle<control_system::srv::Altitud_Request>()
{
  return &control_system::srv::typesupport_fastrtps_cpp::_Altitud_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = control_system::srv::Altitud_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const control_system::srv::Altitud_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<control_system::srv::Altitud_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &control_system::srv::typesupport_fastrtps_cpp::_Altitud_Response__handle;
}
...
{
  return &control_system::srv::typesupport_fastrtps_cpp::_Altitud__handle;
}
