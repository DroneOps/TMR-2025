...
class DroneControlEulerNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('kp', 0.000001)
        self.declare_parameter('ki', 0.0000001)
        self.declare_parameter('kd', 0.1)
        self.declare_parameter('mass', 1.6)          # drone mass in kg
    ...
    def control_loop(self):
        ...
        max_roll_angle = 5  # Limit roll angle to 5 degrees
        max_roll_control_value = max_roll_angle / 90  # Control value for 5 degrees
        ...
        # Limit the roll control value to the max allowed value
        phi_argument = clamp(phi_argument, -max_roll_control_value, max_roll_control_value)
