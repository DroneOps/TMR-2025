...
bool mission_control__srv__altitud__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // reponse_altitud
    PyObject * field = PyObject_GetAttrString(_pymsg, "reponse_altitud");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->reponse_altitud = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * mission_control__srv__altitud__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // reponse_altitud
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->reponse_altitud);
    {
      int rc = PyObject_SetAttrString(_pymessage, "reponse_altitud", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
