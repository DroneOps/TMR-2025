...
class Init_Altitud_Response_reponse_altitud
{
public:
  Init_Altitud_Response_reponse_altitud()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::mission_control::srv::Altitud_Response reponse_altitud(::mission_control::srv::Altitud_Response::_reponse_altitud_type arg)
  {
    msg_.reponse_altitud = std::move(arg);
    return std::move(msg_);
  }
...
{
  return mission_control::srv::builder::Init_Altitud_Response_reponse_altitud();
}
