...
struct Altitud_Response_
{
  ...
  // field types and members
  using _reponse_altitud_type =
    double;
  _reponse_altitud_type reponse_altitud;

  // setters for named parameter idiom
  Type & set__reponse_altitud(
    const double & _arg)
  {
    this->reponse_altitud = _arg;
    return *this;
  }
  ...
  {
    if (this->reponse_altitud != other.reponse_altitud) {
      return false;
    }
    return true;
  }
